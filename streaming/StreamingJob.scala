...
trait StreamingJob {
  ...
  def computeByteCountByType(dataFrame: DataFrame): DataFrame
  ...
  def run(args: Array[String]): Unit = {
    ...
    val DF = computeByteCountByType(antennaDF)
    val aggFuture = writeToJdbc(DF, jdbcUri, aggJdbcTable, jdbcUser, jdbcPassword)
