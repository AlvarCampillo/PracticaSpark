...
object JdbcProvisioner {
  ...
  def main(args: Array[String]) {
    val IpServer = "35.232.169.53"

    // connect to the database
    val driver = "org.postgresql.Driver"
    val url = s"jdbc:postgresql://35.232.169.53:5432/postgres"
